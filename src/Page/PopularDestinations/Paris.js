...
import styles from "./Paris.module.scss";

const cx = classNames.bind(styles);
function Paris() {
  return (
    <div className={cx("Paris")}>
      <div className={cx("image-main")}>
        ...
        />
        <h1 className={cx("image-main-title")}>Paris</h1>
      </div>
      <div className={cx("content")}>
        <div className={cx("center")}>
          <h2>
            Today, Paris offers a seemingly unlimited choice of shopping,
